...
- Move initialization logic of view classes out of `View` and into their
  respective classes to simplify creating view based protocols.
- Make `View` instantiable to allow maintaining multiple protocols at once e.g.
  for versioning.
