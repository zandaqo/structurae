const UnweightedAdjacencyList = require('./unweighted-adjacency-list');
const UnweightedAdjacencyMatrix = require('./unweighted-adjacency-matrix');
const WeightedAdjacencyListMixin = require('./weighted-adjacency-list');
const WeightedAdjacencyMatrixMixin = require('./weighted-adjacency-matrix');
 ...
 * @param {CollectionConstructor} [classOptions.Collection]
 * @param {boolean} [classOptions.weighted]
 * @param {boolean} [classOptions.undirected]
 * @param {boolean} [classOptions.list]
 * @returns {Graph}
 */
function GraphMixin(classOptions = {}) {
  const Base = classOptions.weighted ? classOptions.list
    ? WeightedAdjacencyListMixin(classOptions.Collection)
    : WeightedAdjacencyMatrixMixin(classOptions.Collection, classOptions.undirected)
    : classOptions.list ? UnweightedAdjacencyList : UnweightedAdjacencyMatrix;
  ...
  Graph.undirected = !!classOptions.undirected;

  Graph.weighted = !!classOptions.weighted;
