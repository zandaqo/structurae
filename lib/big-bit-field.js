...
class BigBitField {
  /**
   * @param {bigint|BigBitField|Array<number>|Object<string, number>} [data=0]
   * @example
   *
  ...
  constructor(data = ZERO) {
    this.value = data instanceof BigBitField ? data.valueOf()
      : typeof data === 'object' ? this.constructor.encode(data) : BigInt(data);
  }
